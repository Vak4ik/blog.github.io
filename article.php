...
{
  $id = $_GET['id'];
  $page = "article.php?id=$id#comment-add-form";
  ...
  header("Location: ". $_SERVER["REQUEST_URI"]);
                    ...
                    if( isset($_POST['do_post']) )
                    {
                      ...
                      if( empty($errors) ) 
                      {
                        ...
                        mysqli_query($connection, "INSERT INTO `comments` (`author`, `nickname`, `text`, `pubdate`, `articles_id`, `email`) VALUES ('".$_POST['name']."', '".$_POST['nickname']."', '".$_POST['text']."', NOW(), '".$art['id']."', '".$_POST['email']."') ");
                        // зачистка полей формы после успешной её отправки
                        /*$_POST['name'] = '';
                        $_POST['nickname'] = '';
                        $_POST['text'] = '';
                        $_POST['email'] = '';*/
                        $statement_redir = true;
                ...
                <form class="form" method="POST" action="">
                  ...
                  <div class="form__group">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <input style="margin-top: 10px;"type="text" class="form__control" name="email" placeholder="Email (не будет показан)" value='<?php echo $_POST['email'];?>'>
                      </div>
                    </div>
                  </div>
                  <div class="form__group">
                    <textarea name="text" class="form__control" placeholder="Текст комментария ..." value='<?php echo $_POST['text'];?>'><?php echo $_POST['text'];?></textarea>
                  </div>
                  <div class="form__group">
